...
# Number of unique songs  in the data
print('Number of unique Songs in Raw data = ', df1['songs'].nunique())
# Number of unique Album in the data
print('Number of unique Album in Raw data = ', df1['Album'].nunique())
# Number of unique singer  in the data
print('Number of unique Singer in Raw data = ', df1['Singer'].nunique())
# Number of unique genre  in the data
print('Number of unique Genre in Raw data = ', df1['Genre'].nunique())
# Number of unique rating  in the data
print('Number of unique Ratings in Raw data = ', df1['Ratings'].nunique())
